...
export function AdminPanelLayout() {
  ...
  const pageName = pageNameByPath[location.pathname] || 'Admin'
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="px-5 py-4 border-b border-white/10 shrink-0">
          <div className="inline-flex items-center rounded-xl bg-white/10 px-3 py-1.5">
            <span className="text-xs font-semibold tracking-wide text-white">Page</span>
            <span className="ml-2 text-xs font-bold text-[#21cdc0] bg-white/90 px-2 py-0.5 rounded-lg">
              {pageName}
            </span>
          </div>
        </div>
