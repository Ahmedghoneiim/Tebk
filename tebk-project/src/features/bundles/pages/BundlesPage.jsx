          ...
          : bundles.map(bundle => (
            <div key={bundle.id} className="card flex flex-col">
              <div className="flex items-start justify-between mb-3">
                <div className="w-10 h-10 rounded-xl bg-clinical flex items-center justify-center mr-3 flex-shrink-0 overflow-hidden">
                  {bundle.image_url
                    ? <img src={cl.thumb(bundle.image_url, 160)} alt={bundle.name} className="w-full h-full object-cover rounded-xl" />
              ...
              {bundle.items && bundle.items.length > 0 ? (
                ...
                <p className="text-xs text-muted mb-4 italic">Details available on request</p>
              )}
